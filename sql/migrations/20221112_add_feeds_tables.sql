ALTER TABLE app_users ADD COLUMN email character varying(500) NOT NULL DEFAULT '';
ALTER TABLE app_users ADD COLUMN digest_at time without time zone NOT NULL DEFAULT '15:00:00';
ALTER TABLE app_users ADD COLUMN last_digest_at timestamp without time zone;
